...
├── timescaledb/
│   └── init.sql                # Script de setup do TimescaleDB
├── .dockerignore               # Arquivos ignorados no build
└── README.md                   # Este arquivo
```

**IMPORTANTE:** Todos os comandos `docker-compose` devem ser executados **de dentro desta pasta** (`docker/`)!
...
```bash
cd ~/Documentos/Estudos/moodle-plugin-rework/docker
